...
// 获取上传配置信息
export const getUploadSystemSetting = params => {
  // return Axios.get(BASE_PATH + '/modelmgmt/model/get/' + params.id).then(res => res.data)
  return Axios.get(BASE_PATH + '/modelmgmt/systemsettings/getfileuploadsettings').then(res => res.data)
}
// 上传文件信息
export const uploadVersionFileInfo = (data) => {
  return Axios.post(BASE_PATH + '/modelmgmt/web/uploadversfileinfo', data).then(res => res.data)
}
