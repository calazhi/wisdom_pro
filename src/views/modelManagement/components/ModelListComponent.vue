          ...
          <template slot-scope="scope">
            ...
            <el-dropdown @command="handleCommand($event, scope.$index, scope.row)" trigger="click">
              ...
              <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item v-if="scope.row.nodeType == 'mm.nodtyp.structured'" class="model-dropdown-item" command="taskplan"><i class="el-icon-time"></i>查看计划</el-dropdown-item>
                <el-dropdown-item class="model-dropdown-item" command="excuteStatus"><i class="el-icon-search"></i>运行状况</el-dropdown-item>
                <el-dropdown-item v-if="scope.row.modelStatus=='mm.modsts.enable' && scope.row.nodeType == 'mm.nodtyp.structured'" class="model-dropdown-item" command="stop"><i class="el-icon-remove"></i>停用模型</el-dropdown-item>
                <el-dropdown-item v-if="scope.row.modelStatus=='mm.modsts.disable' && scope.row.nodeType == 'mm.nodtyp.structured'" class="model-dropdown-item" command="resume"><i class="el-icon-caret-right"></i>启用模型</el-dropdown-item>
                <!--<el-dropdown-item>螺蛳粉</el-dropdown-item>-->
                <el-dropdown-item v-if="scope.row.nodeType == 'mm.nodtyp.structured'" class="model-dropdown-item" command="edit" divided><i class="el-icon-edit-outline"></i>修改</el-dropdown-item>
                <el-dropdown-item v-if="scope.row.nodeType == 'mm.nodtyp.structured'" class="model-dropdown-item" command="delete" ><i class="el-icon-delete"></i>删除</el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
