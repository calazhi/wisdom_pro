...
// 5. 查询设备分类部分信息的接口
export const getDeviceCategories = (val, typeCode) => {
  return Axios.get(DEVICE_CATEGORY_PATH + '/getDeviceCategoriesSimpleByCondition', {params: {'keyword': val, 'typeCode': typeCode}}
  ).then(res => res.data)
}
