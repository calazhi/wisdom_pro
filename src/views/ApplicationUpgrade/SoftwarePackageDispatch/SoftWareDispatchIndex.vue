    ...
    <el-form :inline="true" :model="queryList">
      <div class="search-container">
        ...
        <el-form-item label="软件包版本">
          <el-input v-model.trim="queryList.packageVersion" placeholder="请输入软件包版本" clearable :maxlength="maxlength" class="appupgrade_el-select" @keyup.enter.native="_handleFilter"></el-input>
        </el-form-item>
        <el-form-item label="开发者">
          <el-input v-model.trim="queryList.packageProvider" placeholder="请输入开发者" clearable :maxlength="maxlength" class="appupgrade_el-select" @keyup.enter.native="_handleFilter"></el-input>
        </el-form-item>
