      ...
      <el-form :inline="true" :model="searchConditionList">
        <div class="search-container">
          <el-form-item label="代码中文名称">
            <el-input class="appupgrade_el-select" placeholder="请输入代码中文名称" v-model.trim="searchConditionList.codeName" @keyup.enter.native="_handleFilter"> </el-input>
          </el-form-item>
          <el-form-item label="代码值" :label-width="formLabelWidth">
            <el-input class="appupgrade_el-select" placeholder="请输入代码值" v-model.trim="searchConditionList.code" @keyup.enter.native="_handleFilter"> </el-input>
          </el-form-item>
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="代码大类名称" :label-width="formLabelWidth" prop="typeCode">
                <el-select v-model="registerParaList.typeCode" placeholder="请选择代码大类名称" style="width:320px;" clearable>
