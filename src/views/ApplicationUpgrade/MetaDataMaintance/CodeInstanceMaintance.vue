      ...
      <el-form :inline="true" :model="searchConditionList">
        <div class="search-container">
          <el-form-item label="代码实例名称">
            <el-input class="appupgrade_el-select" placeholder="请输入代码实例值" v-model.trim="searchConditionList.code" @keyup.enter.native="_handleFilter"> </el-input>
          </el-form-item>
          <el-form-item label="软件名称" :label-width="formLabelWidth">
            <el-input class="appupgrade_el-select" placeholder="请输入软件名称" v-model.trim="searchConditionList.codeName" @keyup.enter.native="_handleFilter"> </el-input>
          </el-form-item>
          <el-form-item label="提供商" :label-width="formLabelWidth">
            <el-input class="appupgrade_el-select" placeholder="请输入提供商" v-model.trim="searchConditionList.vendor" @keyup.enter.native="_handleFilter"> </el-input>
          </el-form-item>
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="代码类型" :label-width="formLabelWidth" prop="instanceValue">
                <el-select v-model="registerParaList.instanceValue" placeholder="请选择代码类型" style="width:320px;" clearable>
