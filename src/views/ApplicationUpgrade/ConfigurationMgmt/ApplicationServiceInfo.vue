<template>
  <div class="ui-common">
    ...
    <div v-loading="synDataLoading" element-loading-background="rgba(0, 0, 0, 0.8)" element-loading-text="玩命异步更新中,稍后手动刷新数据...">
      <div style="margin-top: 10px">
        <el-table :data="appServiceListData" stripe border v-loading="loading" height="680">
          ...
          <el-table-column v-for="(item, index) in tableTitleList " :key="index" :prop="item.prop" v-if="item.showColumn" :label="item.colName" sortable min-width="200">
          </el-table-column>
    ...
    <el-dialog :title="dialogStatus" :visible.sync="dialogShowColsVisible" width="55%">
