...
export default {
  ...
  beforeMount () {
    ...
    */
    if (localStorage.getItem('CurrentlyUrl') !== undefined) {
      console.log('sidebar.vue_beforeMount_  CurrentlyUrl :' + localStorage.getItem('CurrentlyUrl'))
      this.openeds.push(localStorage.getItem('CurrentlyUrl'))
    } else {
  ...
  mounted () {
    ...
    let tempTitle = localStorage.getItem('CurrentlyCheckedTitle')
  ...
  computed: {
    onRoutes () {
      ...
      localStorage.setItem('CurrentlyUrl', this.$route.path)
  ...
  watch: {
    checkedTitle (curVal, oldVal) {
      ...
      if (curVal) {
        localStorage.setItem('CurrentlyCheckedTitle', curVal)
